  ...
  return (
    <S.NewsInfo>
      <G.Container>
        ...
        molestiae non provident quibusdam. Animi dicta exercitationem illo incidunt perspiciatis possimus quae rem
        tempore. Accusamus doloremque magni quaerat saepe suscipit, temporibus veritatis. Ab architecto, beatae
