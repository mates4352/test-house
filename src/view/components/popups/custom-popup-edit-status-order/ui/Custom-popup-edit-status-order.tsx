...
export const CustomPopupEditStatusOrder: FC<CustomPopupEditStatusOrderType> =
        ...
        <S.List>
          <S.Item>
            <S.Button
              type={'button'}
              onClick={
                onChangeStatusOrder && onChangeStatusOrder(StatusOrder.SENT)
              }>
              {StatusOrder.SENT}
            </S.Button>
          </S.Item>
          ...
          <S.Item>
            <S.Button
              ...
              onClick={
                onChangeStatusOrder &&
                onChangeStatusOrder(StatusOrder.IN_PROCESSING)
              }>
          ...
          <S.Item>
            <S.Button
              type={'button'}
              onClick={
                onChangeStatusOrder && onChangeStatusOrder(StatusOrder.ACCEPTED)
              }>
